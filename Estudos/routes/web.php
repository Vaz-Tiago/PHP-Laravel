...
Route::get('/aspnetcore/filters', ['as' => 'AspNetCore.Filters', 'uses' => 'AspNetCoreController@Filters'] );
...
Route::get('/aspnetcore/mid', ['as' => 'AspNetCore.Mid', 'uses' => 'AspNetCoreController@Mid'] );
